...
export const cases: CaseStudy[] = [
  {
    ...
    diagram: `delta   mvu   nep   delco   alexrenew   carmel   aruba   [client]
  │      │     │      │        │          │        │      │
  └──────┴─────┴──────┴───┬────┴──────────┴────────┴──────┘
                          ▼
              ┌───────────────────────┐
    ...
    sections: [
      {
        heading: "Problem",
        paragraphs: [
          "Eight utility companies - Delta, MVU, NEP, DelCo, Alex Renew, Carmel, Web Aruba, [client] - each needed a customer portal talking to Oracle Utilities CCS. The legacy server they inherited had authorization gaps and no clean way to vary behavior per tenant. Every new client meant forked code and re-audited security.",
