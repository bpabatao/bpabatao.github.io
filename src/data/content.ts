...
export const currentJobs: Job[] = [
  ...
  },
  {
    ...
    resumeReceipts: [
      ...
      "Contributed to real-time collaboration (GraphQL subscriptions), OpenAI-backed generation features, and platform security (OWASP/IDOR, JWT sessions); built AI Context Configuration - a per-strategy, per-user assistant response mode only a non-external strategy lead can choose, clamped on read and refused on write otherwise - plus help-centre retrieval.",
    ],
