...
export const currentJobs: Job[] = [
  {
    ...
    receipts: [
      ...
      "Made the Snyk supply-chain gate real across 14 repositories, then rolled keyless OIDC deploys - replacing long-lived AWS credentials in CI - through pilot, all test envs, and prod on 4 of them.",
    ...
    resumeReceipts: [
      ...
      "**Made the supply-chain gate real across 14 repositories** - a blocking Snyk scan ahead of build and deploy on every pipeline - then rolled keyless OIDC deploys through pilot, all test environments, and production on 4 of them, taking long-lived AWS credentials out of CI.",
