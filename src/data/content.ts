...
export const currentJobs: Job[] = [
  ...
  },
  {
    ...
    receipts: [
      ...
      "Cut observability cost and noise - removed a dead-pipe New Relic integration billing ~$176/month, quieted empty-query probe errors flooding production Sentry - onto an existing in-house observability layer.",
