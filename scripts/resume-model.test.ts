...
test("model uses ASCII separators, resume overlays and Present", () => {
  ...
  /* the employer line must carry the FULL tenure so ATS date extraction sees 3 years,
     not just the current title's span; the current title keeps its own line. */
